    ...
    <form role="search" method="get" class="search-form" action="{{ home_url('/') }}">
      <div class="border border-gray-200 flex flex-wrap lg:flex-nowrap">
        <div class="flex flex-1 items-center lg:mb-0 lg:w-2/3 mb-3 px-4 rounded w-full">
          ...
          <input class="outline-none pl-3 text-blueGray-400 text-xs w-full" type="search" placeholder="Busca en el sitio" value="{{ get_search_query() }}" name="s">
        </div>
        <button class="bg-gray-700 font-semibold hover-up-2 hover:bg-gray-800 leading-none lg:ml-6 lg:w-auto px-8 py-4 text-white text-xs w-full" type="submit">Buscar</button>
      </div>
    </form>
  </div>
